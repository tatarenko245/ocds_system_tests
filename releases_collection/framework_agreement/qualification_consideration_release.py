"""Prepare the expected releases of the qualification consideration process, framework agreement procedures."""
import copy


class QualificationConsiderationRelease:
    ...
    def build_expected_fe_release(self, previous_fe_release, actual_fe_release, qualification_id):
        ...
        for q in range(len(expected_qualifications_array)):
            if expected_qualifications_array[q]['id'] == qualification_id:
                expected_qualifications_array[q]['statusDetails'] = "consideration"
