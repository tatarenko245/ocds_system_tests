...
class TestCreatePIN:
    ...
    if country == "MD":
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN, де payer/funder/buyer/PE різні організації, для Молдови.")
        # def test_case_6(self, get_parameters, connect_to_keyspace, create_fs_tc_1_new):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN, де payer/funder/buyer/PE одна організація, для Молдови.")
        # def test_case_7(self, get_parameters, connect_to_keyspace, create_fs_tc_2_new):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #     connect_to_auctions = connect_to_keyspace[8]
        #
        #     currency = create_fs_tc_2_new[0]
        #     ei_cpid = create_fs_tc_2_new[2]
        #     ei_url = create_fs_tc_2_new[4]
        #     fs_ocid = create_fs_tc_2_new[7]
        #     fs_url = create_fs_tc_2_new[9]
        #     buyer_id = create_fs_tc_2_new[11]
        #     buyer_scheme = create_fs_tc_2_new[12]
        #
        #     previous_ei_release = requests.get(ei_url).json()
        #     previous_fs_release = requests.get(fs_url).json()
        #
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN, повна модель з FS без опціональних атрибутів, для Молдови.")
        # def test_case_10(self, get_parameters, connect_to_keyspace, create_fs_tc_3_new):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #     connect_to_auctions = connect_to_keyspace[8]
        #
        #     currency = create_fs_tc_3_new[0]
        #     ei_cpid = create_fs_tc_3_new[2]
        #     ei_url = create_fs_tc_3_new[4]
        #     fs_ocid = create_fs_tc_3_new[7]
        #     fs_url = create_fs_tc_3_new[9]
        #     buyer_id = create_fs_tc_3_new[11]
        #     buyer_scheme = create_fs_tc_3_new[12]
        #
        #     previous_ei_release = requests.get(ei_url).json()
        #     previous_fs_release = requests.get(fs_url).json()
        #
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Повторне створення PIN повна модель, з використанням одного EI і FS, для Молдови.")
        # def test_case_12(self, get_parameters, connect_to_keyspace, create_fs_tc_1_new):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #
        #     step_number = 1
        #     with allure.step(f"# {step_number}. Authorization platform one: Create PIN 1 process."):
        #         """
        #         Tender platform authorization for Create PIN process.
        #         As result, get tender platform's access token and process operation-id.
        #         """
        ...
        #
        #     step_number += 1
        #     with allure.step(f"# {step_number}. Send a request to create a Create PIN 1 process."):
        #         """
        #         Send api request to BPE host to create a Create PIN process.
        #         """
        #
        ...
        #
        #     step_number += 1
        #     with allure.step(f"# {step_number}. Authorization platform one: Create PIN 2 process."):
        #         """
        #         Tender platform authorization for Create PIN process.
        #         As result, get tender platform's access token and process operation-id.
        #         """
        ...
        #
        #     step_number += 1
        #     with allure.step(f"# {step_number}. Send a request to create a Create PIN 2 process."):
        #         """
        #         Send api request to BPE host to create a Create PIN process.
        #         """
        #
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        @allure.title("В запиті немає budget.budgetBreakdown[*].classifications.fs  для Молдови.")
        def test_case_14(self, get_parameters, connect_to_keyspace, create_fs_tc_1_new):
            ...
            with allure.step(f"# {step_number}. Send a request to create a Create PIN process."):
                ...
                try:
                    ...
                    del payload['planning']['budget']['budgetBreakdown'][0]['classifications']['fs']
                except ValueError:
                    raise ValueError("Impossible to build payload for Create PIN process.")
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN після withdraw EI і повторного підтвердження, для Литви.")
        # def test_case_5(self, get_parameters, connect_to_keyspace, confirm_ei_tc_2):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #     connect_to_auctions = connect_to_keyspace[8]
        #
        #     ei_cpid = confirm_ei_tc_2[0]
        #     ei_url = confirm_ei_tc_2[3]
        #     currency = confirm_ei_tc_2[4]
        #
        #     previous_ei_release = requests.get(ei_url).json()
        #
        #     """
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN, де buyer = PE, для Литви.")
        # def test_case_8(self, get_parameters, connect_to_keyspace, confirm_ei_tc_1):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Створити PIN, де buyer і PE - різні організації, для Литви.")
        # def test_case_9(self, get_parameters, connect_to_keyspace, confirm_ei_tc_1):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
        ...
        #                           "Cassandra DataBase: steps of process.")
        #
        # @allure.title("Повторне створення PIN повна модель, з використанням одного EI, для Литви.")
        # def test_case_11(self, get_parameters, connect_to_keyspace, confirm_ei_tc_1):
        #
        #     environment = get_parameters[0]
        #     bpe_host = get_parameters[2]
        #     service_host = get_parameters[3]
