...
class TestCompleteQualification:
    ...
    def test_case_2(self, get_parameters, connect_to_keyspace, qualification_protocol_tc_2):
        ...
        cpid = qualification_protocol_tc_2[0]
        token = qualification_protocol_tc_2[2]
        ap_url = qualification_protocol_tc_2[4]
        fa_url = qualification_protocol_tc_2[5]
        ocid = qualification_protocol_tc_2[23]
        fe_url = qualification_protocol_tc_2[24]
