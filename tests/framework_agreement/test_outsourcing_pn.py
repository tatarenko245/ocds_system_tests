...
class TestOutsourcingPN:
    ...
    def test_case_1(self, get_parameters, connect_to_keyspace, create_first_ap_tc_1):
        ...
        fa = create_first_ap_tc_1[1]
        ap = create_first_ap_tc_1[2]
        ap_url = create_first_ap_tc_1[7]
        fa_url = create_first_ap_tc_1[8]
        cpid = create_first_ap_tc_1[9]
        ocid = create_first_ap_tc_1[10]
        token = create_first_ap_tc_1[11]
        pn_url = create_first_ap_tc_1[12]
        ms_url = create_first_ap_tc_1[13]
    ...
    def test_case_2(self, get_parameters, connect_to_keyspace, create_first_ap_tc_2):
        ...
        fa = create_first_ap_tc_2[1]
        ap = create_first_ap_tc_2[2]
        ap_url = create_first_ap_tc_2[7]
        fa_url = create_first_ap_tc_2[8]
        cpid = create_first_ap_tc_2[9]
        ocid = create_first_ap_tc_2[10]
        token = create_first_ap_tc_2[11]
        pn_url = create_first_ap_tc_2[12]
        ms_url = create_first_ap_tc_2[13]
