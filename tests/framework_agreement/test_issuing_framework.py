...
from functions_collection.requests_collection import complete_qualification_process, issuing_framework_process
...
class TestIssuingFramework:
    ...
    def test_case_1(self, get_parameters, connect_to_keyspace, complete_qualification_tc_1):
        ...
        contract_token = complete_qualification_tc_1[33]
