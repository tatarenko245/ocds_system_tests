...
def issuing_framework_tc_1(get_parameters, prepare_currency, connect_to_keyspace):
...
def issuing_framework_tc_2(get_parameters, prepare_currency, connect_to_keyspace):
    environment = get_parameters[0]
    bpe_host = get_parameters[2]
    service_host = get_parameters[3]
    country = get_parameters[4]
